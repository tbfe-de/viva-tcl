...
Again a really compact server, able to serve as many [`emb2_cl.tcl`] clients as are started. Other than in
[`emb1.tcl`] which uses polling to notice changes on `port_pins` and send updates to the client(s), [`emb2.tcl`]
